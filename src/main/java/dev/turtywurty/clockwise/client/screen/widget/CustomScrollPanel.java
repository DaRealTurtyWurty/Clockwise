...
public abstract class CustomScrollPanel extends AbstractContainerEventHandler implements Renderable, NarratableEntry {
    ...
    protected final int bgColorFrom;
    protected final int bgColorTo;
    protected final int barBgColor;
    protected final int barColor;
    protected final int barBorderColor;
     ...
     */
    public CustomScrollPanel(Minecraft client, int width, int height, int top, int left) {
     ...
     */
    public CustomScrollPanel(Minecraft client, int width, int height, int top, int left, int border) {
     ...
     */
    public CustomScrollPanel(Minecraft client, int width, int height, int top, int left, int border, int barWidth) {
     ...
     */
    public CustomScrollPanel(Minecraft client, int width, int height, int top, int left, int border, int barWidth, int bgColor) {
     ...
     */
    public CustomScrollPanel(Minecraft client, int width, int height, int top, int left, int border, int barWidth, int bgColorFrom, int bgColorTo) {
     ...
     */
    public CustomScrollPanel(Minecraft client, int width, int height, int top, int left, int border, int barWidth, int bgColorFrom, int bgColorTo, int barBgColor, int barColor, int barBorderColor) {
        this.client = client;
        this.width = width;
        this.height = height;
        this.top = top;
    ...
    protected int getBarHeight() {
        ...
        if (barHeight > height - border * 2) barHeight = height - border * 2;
